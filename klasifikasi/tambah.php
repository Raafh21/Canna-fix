...
function tambah($data)
{
    ...
    mysqli_query($conn, "INSERT INTO tb_klasifikasi 
                VALUES
                ('','$nama_siswa','$nama_sekolah','$nilai_mtk1','$nilai_mtk2','$nilai_mtk3','$nilai_mtk4','$nilai_mtk5','$mtk_rata','$mtk_grade','$nilai_ipa1','$nilai_ipa2','$nilai_ipa3','$nilai_ipa4','$nilai_ipa5','$ipa_rata','$ipa_grade','$nilai_ips1','$nilai_ips2','$nilai_ips3','$nilai_ips4','$nilai_ips5','$ips_rata','$ips_grade','$minat','$nilai_tes','$tes_grade','$hasil','$hasil_uji','$id_rule')");
...
if (isset($_POST["tambah"])) {
    ...
    if (tambah($_POST) > 0) {
        ...
        header("Location: ../riwayat-klasifikasi.php");
    } else {
        $_SESSION['status'] = "Admin Baru";
