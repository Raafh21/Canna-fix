...
--
-- Table structure for table `tb_training2`
--

CREATE TABLE `tb_training2` (
  `id` int(11) NOT NULL,
  `nama_siswa` varchar(255) NOT NULL,
  `minat` varchar(255) NOT NULL,
  `ipa_grade` varchar(256) NOT NULL,
...
INSERT INTO `tb_training2` (`id`, `nama_siswa`, `minat`, `ipa_grade`, `mtk_grade`, `ips_grade`, `nilai_tes`, `hasil`) VALUES
...
--
-- Indexes for table `tb_training2`
--
...
--
-- AUTO_INCREMENT for table `tb_training2`
--
ALTER TABLE `tb_training2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=526;
